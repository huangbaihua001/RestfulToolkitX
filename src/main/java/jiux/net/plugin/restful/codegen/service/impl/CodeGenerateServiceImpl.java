...
import jiux.net.plugin.restful.codegen.entity.Callback;
import jiux.net.plugin.restful.codegen.entity.SaveFile;
import jiux.net.plugin.restful.codegen.entity.TableInfo;
import jiux.net.plugin.restful.codegen.entity.Template;
import jiux.net.plugin.restful.codegen.service.CodeGenerateService;
...
import jiux.net.plugin.restful.codegen.tool.*;
...
public class CodeGenerateServiceImpl implements CodeGenerateService {
    final Logger LOGGER = Logger.getInstance("CodeGenerateServiceImpl");
    /**
     * 项目对象
     */
...
//        JBIterable<? extends DasColumn> columnsIter = DasUtil.getColumns(null);
...
//        }
        ...
        for (TableInfo tableInfo : tableInfoList) {
            ...
            for (Template template : templates) {
                ...
                // 开始生成
                System.out.println(template.getName() + "=====>" + template.getCode());
