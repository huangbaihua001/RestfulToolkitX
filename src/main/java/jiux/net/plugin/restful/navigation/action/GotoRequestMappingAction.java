...
public class GotoRequestMappingAction extends GotoActionBase implements DumbAware {
  ...
  protected void gotoActionPerformed(AnActionEvent e) {
    ...
    final GotoRequestMappingModel model = new GotoRequestMappingModel(
      project,
    ...
    GotoRequestMappingProvider provider = new GotoRequestMappingProvider(
      getPsiContext(e)
    );
    showNavigationPopup(
      e,
  ...
  protected static class GotoRequestMappingFilter extends ChooseByNameFilter<HttpMethod> {
    ...
    GotoRequestMappingFilter(
      final ChooseByNamePopup popup,
      GotoRequestMappingModel model,
